...
class AnyList<T> extends Notifier<List<T>> {
  @override
  List<T> build({List<T>? initial}) {
    return initial ?? [];
  }
...
// class ImageList extends AnyList<File> {}

// final imageListProvider =
//     NotifierProvider<ImageList, List<File>>(ImageList.new);
